package ar.com.nny.java.base.ui.abm;
...
//		panelDeBotones.addRelatedGap();
	...
	public JLabel addBindingDoubleField(String property, String label){		
		ValueModel nameModel = beanAdapter.getValueModel(property);
		return panelDeAtributos.append(label ,BasicComponentFactory.createFormattedTextField(nameModel, new DecimalFormat("0.##").getNumberInstance()));
	}
