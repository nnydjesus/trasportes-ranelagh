...
import ar.com.nny.base.ui.swing.components.search.WindowsSearchImpl;
import ar.com.syr.transportes.bean.Remito;
import ar.com.syr.transportes.ui.amb.ABMRemito;
import ar.com.syr.transportes.ui.principales.RemitoUI;
...
public class LomaNegra extends ItemComposite{
    public LomaNegra(JFrame parent) {
        ...
        this.add(new WindowsSearchImpl<Remito>( remitos.getSearch()));
    }
