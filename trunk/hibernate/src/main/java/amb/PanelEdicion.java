...
public class PanelEdicion<T > extends JPanel {
	...
	public PanelEdicion(String claseAEditar, T model){
		...
		this.setPanelDeBotones(new JPanel());
	...
	private void construirPanelEdicion() {
		...
		this.getPanelDeBotones().add(this.getBotonAgregar());
		this.getPanelDeBotones().add(this.getBotonModificar());
		this.getPanelDeBotones().add(this.getBotonCancelar());
		
		
		this.beanAdapter = new BeanAdapter(model);
		this.add(this.getTituloEdicion());
		this.add(panelDeAtributos.getPanel());
		this.add(this.getPanelDeBotones());
	...
	public void setPanelDeBotones(JPanel panelDeBotones) {
