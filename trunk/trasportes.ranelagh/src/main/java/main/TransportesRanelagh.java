...
import ar.com.nny.java.base.ui.FrameLook;
import ar.com.nny.java.base.ui.GeneralPanel;
import ar.com.nny.java.base.ui.Preloader;
...
public class TransportesRanelagh extends FrameLook{
	...
	public TransportesRanelagh() {
		super();
		this.topPanel.add(new JLabel(new ImageIcon("./Images/logo.jpg")), BorderLayout.WEST);
